  ...
  return (
    ...
    >
      ...
      <section className="panel financial-report-print">
        ...
        <div className="financial-report__table-wrap">
          <table className="financial-report__table">
            <thead>
              <tr>
                <th>Periode</th>
                <th>Pendapatan</th>
              ...
              {financialReport.length > 0 ? (
                financialReport.map((item) => (
                  <tr key={item.month}>
                    ...
                    <td>{formatCurrency(item.shippingFee)}</td>
                    <td>{formatCurrency(item.labaBersih)}</td>
                    <td>{item.successfulOrders}</td>
